...
def run_developer(forms, agents, buildings, supply_fname, parcel_size,
    ...
    print("default defaut util 656 current demand: ",len(agents))
    print("default defaut util 659 current supply: ",len(buildings))
    print("default defaut util 678 current total units: ",total_units)
    """
    ...
    target_units = dev.\
        compute_units_to_build(len(agents),
                               ...
                               target_vacancy)
    print("default defaut util 718 target units: ",target_units)
    ...
    print("default defaut util 768 old buildings: ",len(old_buildings))
    print("default defaut util 769 new buildings: ",len(old_buildings))
